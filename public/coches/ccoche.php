...
if (isset($_POST['enviar'])) {
    ...
    if (!$errorGeneral) {
        ...
        $coche->setModelo($modelo)
            ...
            ->create();
        $_SESSION['mensaje'] = 'Nuevo Coche Guardado.';
...
?>
    ...
    <body style="background-color:#ff9800">
        <h4 class="text-center">Nueva Coche</h4>
            ...
            <div class="my-2 p-4 mx-auto" style="background-color:#c0ca33; width:40rem">
                <form name="s" action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST' enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="n" placeholder="Nombre Modelo" name="modelo">
                        <?php
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="p" placeholder="Color" name="color">
                        <?php
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="k" required placeholder="Kilometros" name="kms" step='1' min='0'>
